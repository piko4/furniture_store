                        ...
                        <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
                            ...
                            <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
                                <div className="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
                                    <Link href="#" title="" className="text-base font-medium text-primary-700 underline hover:no-underline  text-blue-400"> Sign In or Create Account </Link>
                                    ...
                                    <form action="#">
                                        <div className="items-end space-y-4 sm:flex sm:space-y-0">
                                            ...
                                            <div>
                                                <button type="submit" className="w-full cursor-pointer rounded-lg bg-primary-700 px-5 py-3 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Subscribe</button>
                                            </div>
                                        </div>
                                    </form>
