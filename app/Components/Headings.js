            ...
            <section className="bg-white dark:bg-gray-800">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img className='rounded-2xl' src="https://images.unsplash.com/photo-1613685301586-4f2b15f0ccd4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nzh8fGxpdmluZyUyMHJvb218ZW58MHwwfDB8fHww" alt="mockup" />
                    </div>
                </div>
            </section>
