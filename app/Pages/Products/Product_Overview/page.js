                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 3 </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-2" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No: 0 </label>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-3" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 1 </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-4" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No: 0 </label>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-5" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 0 </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-6" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No: 0 </label>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-7" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 1 </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-8" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No: 0 </label>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-9" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 1 </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      <label for="reviews-radio-10" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No: 0 </label>
                    </div>
                  </div>
                </div>
              </div>
