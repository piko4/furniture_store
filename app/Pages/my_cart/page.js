    ...
    const fetchCartProducts = async () => {
        try {
            ...
            if (
                ...
                const total = productsResponse.data.reduce(
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            <dl className="flex items-center justify-between gap-4">
                                                ...
                                                <dd className="text-base font-medium text-gray-900 dark:text-white">{new Intl.NumberFormat('en-IN', {
                                                    ...
                                                    currency: 'INR',
                                                    minimumFractionDigits: 0,
                                                }).format(totalPrice.toFixed(2))}</dd>
                                            </dl>

                                            <dl className="flex items-center justify-between gap-4">
                                                <dt className="text-base font-normal text-gray-500 dark:text-gray-400">Savings</dt>
                                                <dd className="text-base font-medium text-green-600">-{new Intl.NumberFormat('en-IN', {
                                                    style: 'currency',
                                                    currency: 'INR',
                                                    minimumFractionDigits: 0,
                                                }).format(299.00)}</dd>
                                        ...
                                        <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                            ...
                                            <dd className="text-base font-bold text-gray-900 dark:text-white">{new Intl.NumberFormat('en-IN', {
                                                ...
                                                currency: 'INR',
                                                minimumFractionDigits: 0,
                                            }).format(totalPrice.toFixed(2)-299+99+799)} </dd>
                                        </dl>
                                    </div>
