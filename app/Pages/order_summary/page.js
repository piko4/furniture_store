  ...
  return (
    <div>
      <section class=" bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        {/* tracking */}
        <ol class="mx-auto mb-10 items-center flex w-full max-w-2xl text-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:text-base">
        ...
        {/* oreder summary */}
        <form action="/Pages/delivery" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div class="mx-auto max-w-3xl">
            ...
            <div class="mt-6 space-y-4 border-b border-t border-gray-200 py-8 dark:border-gray-700 sm:mt-8">
              ...
              <button type="button" data-modal-target="billingInformationModal" data-modal-toggle="billingInformationModal" class="text-base font-medium text-blue-700 hover:underline dark:text-blue-500">Edit</button>
            </div>
            ...
            <div class="mt-6 sm:mt-8">
              ...
              <div class="mt-4 space-y-6">
                ...
                <div class="gap-4 sm:flex sm:items-center">
                  ...
                  <button type="submit" class="mt-4 flex w-full items-center justify-center rounded-lg bg-primary-700  px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:mt-0">Send the order</button>
                </div>
              </div>
            </div>
          </div>
